...
const Header = () => {
    ...
    window.addEventListener("scroll", function () {
        ...
        // when the scrool is higher than 200 viewport this.innerHeight, add the show-header class to a tag with the header tag
    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">Giovanni</a>
